...
def cfg() -> AppConfig:
    return AppConfig(
        ...
        # rollover gates off — wiring tests assert entry succeeds; gating
        # behaviour is verified separately in test_rollover_blackout_alignment.
        # rollover_position_reduce_pct=0 keeps size cap from kicking in on BD 5+.
        risk=RiskConfig(
